...
//                }
    ...
    public function deleteAlias($source, $dest)
    {

        $srcAddress = $this->realEscape($source);
        $destAddress = $this->realEscape($dest);
        $isError = FALSE;

        $sql_VirtualAlias = EmailQueries::deleteAlias($srcAddress, $destAddress);
